...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $query = DB::SELECT('SELECT proje.id as proje_id, proje.name as proje_name,proje.is_deleted as deleted, COUNT(resim_rating.rate) as _count, SUM(resim_rating.rate) as rate, COUNT(DISTINCT(images.filename)) as resimlercount
                              FROM proje
